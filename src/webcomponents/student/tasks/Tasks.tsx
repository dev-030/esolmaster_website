        ...
        {hasActiveFilter && (
          <div className="flex items-center justify-between pt-2 border-t border-slate-100">
            ...
            <Button
              ...
              className="h-7 text-xs font-semibold text-slate-500 hover:text-slate-800"
            >
              Clear all filters
            </Button>
          </div>
          ...
          {readingTasks.length > 0 && (
            <div>
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <h2 className="text-base font-semibold text-slate-800">Reading Comprehension</h2>
                <span className="text-xs font-semibold text-slate-400 bg-slate-100 px-2 py-0.5 rounded-full">
                  {readingTasks.length}
                </span>
              </div>
          ...
          {vocabularyTasks.length > 0 && (
            <div>
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <h2 className="text-base font-semibold text-slate-800">Vocabulary & Flashcards</h2>
                <span className="text-xs font-semibold text-slate-400 bg-slate-100 px-2 py-0.5 rounded-full">
